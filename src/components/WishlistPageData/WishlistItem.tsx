...
const WishlistItem = ({ product, handleCloseWishlist }: any) => {
  console.log(product, "From Wishlist");
  ...
  return (
    <div
      ...
      className="flex gap-5 w-full border-b transition duration-300 ease-in-out hover:bg-gray-100 p-4 cursor-pointer"
    >
      {/* == Image container == */}
