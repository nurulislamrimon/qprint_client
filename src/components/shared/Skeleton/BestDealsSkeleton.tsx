            ...
            <div className="flex items-center justify-between">
                ...
                <div className='flex flex-col items-center'>
                    <div className='flex flex-col items-center gap-2.5'>
                        <div className='bg-gray-300 h-2 skeleton rounded-full w-20'></div>
                        <div className='bg-gray-300 h-3 skeleton rounded-full w-52'></div>
                        <div className='bg-gray-300 h-3 skeleton rounded-full w-52'></div>
                    </div>
                    ...
                    <div className='flex flex-col items-center gap-2.5 mt-10'>
                        <div className='bg-gray-300 h-2 skeleton rounded-full w-52'></div>
                        <div className='bg-gray-300 h-2 skeleton rounded-full w-40'></div>
                    </div>
                    <div className="flex items-center gap-4 mt-5">
                        {
                            [...Array(4)].map((_, index) => {
                                return (
                                    <div key={index} className='md:w-[70px] w-[46px] h-[46px] md:h-[70px] skeleton bg-gray-300 rounded-md'></div>
                                )
                            })
                        }
                    </div>
                        ...
                        return (
                            <div key={index} className='bg-gray-300 rounded-custom-10px md:w-[290px] md:h-[70px] flex items-center justify-between px-3 py-1'>
                                ...
                                <div className='flex flex-col  gap-2.5 mt-10'>
                                    <div className='bg-gray-400 h-2 skeleton rounded-full w-20'></div>
                                    <div className='bg-gray-400 h-2 skeleton rounded-full md:w-40'></div>
