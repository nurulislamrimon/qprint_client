    ...
    <div className="border-t">
      <div className="pt-3">
        <div className="flex justify-between items-center mb-2.5">
          <p className="text-black-opacity-70 text-[14px]">Subtotal</p>
          <p className="text-black-opacity-70 text-[14px]">
            <b>{subTotal}</b> QAR
          </p>
        </div>
        <div className="flex justify-between items-center mb-2.5 pb-2 border-b">
          <p className="text-black-opacity-7050 text-[14px]">Shipping</p>
          <p className="text-black-opacity-7050 text-[14px]">{shippingFee}</p>
        </div>
