...
const QuickOrderCartItem = ({ product }: any) => {
    ...
    return (
        <div className="flex gap-5 border-b relative">
            <span className="absolute right-0" onClick={() => dispatch(removeFromCart(product))}>
                <IconTrashX stroke={1} width={18} height={18} className="hover:text-red-500 transition-all" />
            </span>
